...
class _OrderPaymentsTabState extends State<OrderPaymentsTab> {
  ...
  Future<void> _loadData() async {
    ...
    // Note: Added loadPayments() call which seemed missing in your snippet
  ...
  Widget _buildPaymentRow(Payment payment) {
    return Container(
      ...
      child: Row(
        children: [
          // Date (Flex 2 to match header)
          Expanded(
            flex: 2,
            child: Text(payment.formattedDate, style: AppTheme.bodyMedium),
          ),

          // Payment Number (Flex 3 to match header)
          Expanded(
            flex: 3,
            child: Text(
          ...
          // Bank/Reference (Flex 4 to match header)
          Expanded(
            flex: 4,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          // Actions (Fixed width to match header spacer)
          SizedBox(
            width: 40,
