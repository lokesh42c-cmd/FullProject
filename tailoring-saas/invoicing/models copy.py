...
Date: 2026-01-26
FIXED: Changed order ForeignKey to OneToOneField
"""
...
class Invoice(models.Model):
    ...
    # ✅ FIXED: Changed to OneToOneField (one order = one invoice)
    order = models.OneToOneField(
        'orders.Order',
        on_delete=models.PROTECT,
        null=True,
        blank=True,
        related_name='invoice',  # ✅ Changed from 'invoices' to 'invoice'
        verbose_name='Order',
